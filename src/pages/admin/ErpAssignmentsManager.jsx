    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-5">
        ...
        <div>
          ...
          <input type="text" name="targetClass" value={formData.targetClass} onChange={handleChange} className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none" placeholder="e.g. B.Tech CSE - 6th Sem" required />
        </div>
