            ...
            <tbody className="divide-y divide-gray-100">
              {assignments.map(a => (
                <tr key={a._id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="p-4 text-gray-600 text-sm">{a.targetClass}</td>
                  <td className="p-4 text-gray-500 text-sm">{new Date(a.createdAt).toLocaleDateString()}</td>
                  <td className="p-4 text-right">
                    <a href={a.fileUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700 mr-4" title="View/Download">
